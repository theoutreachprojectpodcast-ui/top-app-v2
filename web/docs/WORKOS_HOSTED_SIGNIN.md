...
2. In WorkOS Dashboard → **User Management** → your organization → **Users** → **Invite user** and add each approved admin email (`theoutreachprojectpodcast@gmail.com`, etc.).
