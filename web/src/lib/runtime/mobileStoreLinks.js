 ...
 * Set when listings are live; until then the download button links to /download.
 */
...
/**
 * Best store URL for the current browser, or `/download` landing when unknown / pre-launch.
