...
const DEFAULT_LOGO_DARK = "/brand-logo-site-dark.png?v=13";
const DEFAULT_LOGO_LIGHT = "/brand-logo-site-light.png?v=13";
const DEFAULT_MARK_DARK = "/brand-logo-mark-dark.png?v=11";
const DEFAULT_MARK_LIGHT = "/brand-logo-mark-light.png?v=11";
