...
const GUIDE_DEFS = [
  {
    ...
    imageAlt: "Community members connecting through The Outreach Project",
    mediaCaption:
      "Four moves: create your account, finish your profile, explore trusted resources and the directory, then engage in Community and the podcast.",
  ...
  },
  {
    ...
    imageAlt: "Create your Outreach Project account",
    mediaCaption: "Use WorkOS sign-in with the email you want on your profile, then confirm Profile loads your name.",
    link_url: cta("/api/auth/workos/signup?returnTo=/community", "Create your account"),
    intro:
  ...
  },
  {
    ...
    imageAlt: "Sponsors and membership on The Outreach Project",
    mediaCaption: "Review sponsors, open Membership & billing when ready, and use transparent sponsor disclosures on listings.",
  ...
  },
  {
    ...
    imageAlt: "Nonprofit partners in the trusted network",
    mediaCaption: "Keep listings accurate, request trusted review when you qualify, and encourage consented community stories.",
  ...
  },
  {
    ...
    imageAlt: "The Outreach Project community guidelines",
    mediaCaption: "Be respectful and specific, protect privacy, and expect moderator review to keep the feed safe.",
