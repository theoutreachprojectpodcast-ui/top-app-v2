  ...
  return (
    <div className="legalPageRoute">
      <section className="panel legalPage legalPage--terms">
        ...
        <p>You agree to provide accurate information and keep your account information current.</p>
        <p>You are responsible for all activity that occurs under your account.</p>

        <h2>4. Memberships and Payments</h2>
        <p>Certain features may require a paid membership.</p>
        <p>Payments are processed through Stripe or authorized payment processors.</p>
        <p>
        ...
        <p>of any listed organization or resource.</p>
        <p>
          Inclusion in the directory does not constitute endorsement, certification, accreditation, recommendation, or
        ...
        <p>Users may create, post, or share content.</p>
        <p>You retain ownership of content you submit.</p>
        <p>
          By posting content, you grant The Outreach Project LLC a non-exclusive, worldwide, royalty-free license to
          display, reproduce, distribute, and promote such content in connection with the Services.
        </p>
        ...
        <ul>
          ...
          <li>Post fraudulent information</li>
        ...
        <p>Users should consult qualified professionals regarding their individual circumstances.</p>

        <h2>11. Crisis and Emergency Disclaimer</h2>
        <p>The Outreach Project LLC is not:</p>
        <ul>
          <li>A crisis intervention service</li>
          <li>Emergency response provider</li>
          <li>Healthcare provider</li>
          <li>Mental health treatment provider</li>
        </ul>
        <p>If you are experiencing an emergency, call 911 immediately.</p>
        <p>
          If you are experiencing suicidal thoughts, emotional distress, or a mental health crisis, call or text 988
          immediately.
        </p>
        <p>
          Use of the Services does not create any provider-patient, therapist-client, attorney-client, fiduciary, or
        ...
        <p>
          To the fullest extent permitted by law, The Outreach Project LLC, its members, managers, employees, volunteers,
          sponsors, contractors, affiliates, successors, and assigns shall not be liable for any indirect, incidental,
          consequential, special, punitive, or exemplary damages arising from:
        </p>
        <ul>
          <li>Use of the Services</li>
          <li>Reliance on directory information</li>
          <li>Reliance on podcast content</li>
        ...
        <p>
          ...
          arbitration in Clark County, Nevada, except where prohibited by law.
        </p>
        <p>Each party waives the right to participate in a class action lawsuit.</p>

        <h2>19. Changes to Terms</h2>
        <p>The Outreach Project LLC may modify these Terms at any time.</p>
